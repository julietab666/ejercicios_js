...
const encontrado1 = ambulancias.find(ambulancia => ambulancia.patente === 'TRV 0098');

console.log(encontrado1);

const encontrado2 = ambulancias.findIndex(ambulancia => ambulancia.patente === 'TRV 0098');
