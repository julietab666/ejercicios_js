...
console.log(pacientes_mayus);

const ambulancias_new = ambulancias.map(ambulancia => ({patente: ambulancia.patente, estado: ambulancia.estado}));

console.log(ambulancias_new);

const traslados_metros = traslados.map(traslado => traslado.distanciaKm * 1000);

console.log(traslados_metros);